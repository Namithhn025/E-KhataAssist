    ...
    return (
        <footer className="bg-primary text-white pt-20 pb-10" id="contact">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Contact Form Area */}
                <div className="bg-white rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-12 shadow-2xl relative -mt-16 mb-20 text-gray-900">
